...
|:------------------------------------------------------|:---------------|------------------------------------------|:------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------|
| **`01_Org_MCPT_Minimal`**                             | Organic CSP    |                                          | Fixed Stoichiometry / Single generation and ranking methods / MC Parallel Tempering | High level description of a CSP method for molecular crystals.                                                                                           |
...
| **`07_Org_ROY`**                                      | Organic CSP    | ROY                                      | Fixed Stoichiometry / Multiple ranking methods / Quasi-random sampling              | A popular test case, for the system with the most known experimental polymorphs, ROY                                                                     |
